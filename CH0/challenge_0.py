...
class ImageNumberReader:   
    ...
    def __init__(self, url_image, path):
        ...
        assert url_image.endswith((".jpg",'.png')), f'Wrong url, accepts only .jpg or .png file'
        assert path.endswith((".jpg",'.png')), f'Wrong file name, specify extension, accepts: .jpg .png file.'
